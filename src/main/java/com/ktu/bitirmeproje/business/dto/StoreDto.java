...
public class StoreDto {
	...
	@NotNull
	@Size(min = 2 , max = 20 , message = "Incorret store name")
	...
	public StoreDto(String storeNickName, String storeName, String name, String surname,String e_mail, String password, Address address) {
